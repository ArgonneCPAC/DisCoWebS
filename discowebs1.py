...
mock_version_name = "discowebs_cosmosweb"
...
if __name__ == "__main__":
    ...
    params_bf_bounded, best_loss = opt1_4d.run_optimization_1data(
        data=cosmos_web,
        data_mag_colnames=cosmos_web_mag_colnames,
        N_z_bins=10,
        N_host_min=1000,
        N_host_max=1000,
        n_z_phot_table=10,
        ssp_data=ssp_data_cosmos_web,
        tcurves=tcurves_cosmos_web,
        N_mag_bins=10,
        N_color_bins=10,
        ndsig_by_dbin=0.5,
        num_loops=10,
